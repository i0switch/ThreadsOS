...
function makeReports() {
  return [
    ...
    {
      department: "external-research" as const,
      summary: "リサーチ済み",
    ...
    {
      department: "competitive-analysis" as const,
      summary: "競合比較待ち",
      metrics: { snapshotCount: 1, daysSinceSnapshot: 0 },
      recommendation: "勝ち筋を各部署へ共有",
      lastExecutedAt: null,
    },
    {
      department: "threads" as const,
      summary: "在庫あり",
      metrics: { pendingDrafts: 3, dueSlots: 0, pendingReplies: 0 },
      recommendation: "動く必要なし",
      lastExecutedAt: null,
    },
    {
